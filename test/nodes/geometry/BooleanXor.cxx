...
class BooleanXorTest : public CanvasListener {
public:
	BooleanXorTest();
...
BooleanXorTest::BooleanXorTest() {
	
	shape = NULL;
}

void BooleanXorTest::onCanvasKeyEvent(Canvas &canvas) {
...
void BooleanXorTest::move(const Vec4 &movement) {
...
int main(int argc, char *argv[]) {
	...
	tester.open("test/advanced/BooleanXor.xml");
